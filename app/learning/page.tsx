  ...
  return (
    <div className="p-4 md:p-8 bg-gray-50 min-h-screen max-w-7xl mx-auto">
      ...
      <div className="mb-6 md:mb-8">
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Learning Resources</h1>
        <p className="text-gray-600 mt-2 text-sm md:text-base">Comprehensive Resources for your Success</p>
      </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3 md:gap-4 flex-1 min-w-0">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-gray-800 rounded-lg flex items-center justify-center flex-shrink-0">
                      <IconComponent className="h-4 w-4 md:h-5 md:w-5 text-white" />
                    </div>
                    <div className="flex-1 min-w-0">
                      <h3 className="text-base md:text-lg font-semibold text-gray-900 truncate">{category.name}</h3>
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mt-1">
                        <p className="text-xs md:text-sm text-gray-500">{category.topics.length} topics</p>
                    ...
                    <div className="space-y-2 md:space-y-3">
                      {category.topics.map((topic) => {
                        ...
                        return (
                          ...
                          >
                            <div
                              className={`flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 rounded-lg transition-colors group gap-3 sm:gap-0 ${
                                isCompleted
                            ...
                            >
                              <div className="flex items-center gap-3 flex-1 min-w-0">
                                <div
                                  className={`w-2 h-2 rounded-full flex-shrink-0 ${isCompleted ? "bg-green-500" : "bg-blue-400"}`}
                                ></div>
                                <span
                              ...
                              <div className="flex items-center gap-2 sm:ml-2">
                                <Button
                                  ...
                                  className={`text-xs md:text-sm px-2 md:px-3 py-1 md:py-2 transition-opacity ${
                                    isCompleted
                                ...
                                <Button
                                  ...
                                  className={`text-xs md:text-sm px-2 md:px-3 py-1 md:py-2 transition-opacity ${
                                    isCompleted
                                      ...
                                      : "bg-blue-400 hover:bg-blue-500 text-white sm:opacity-0 sm:group-hover:opacity-100"
                                  }`}
                                >
                                  Read
                                </Button>
